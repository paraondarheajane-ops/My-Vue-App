    ...
    <div class="page">
        ...
        <header class="hero">
            <div class="container">
                ...
                <p class="lead">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto recusandae, nostrum cum maiores
                    molestiae sed totam quam qui tempora placeat odio praesentium consequuntur enim nemo incidunt,
                    voluptatum minus rerum ex!
